...
async function loadTeam() {
    ...
    try {
        ...
        creatorsData = TARGET_LOGINS.map(login => {
            ...
            // Убираем пробелы в шаблонной строке!
...
function renderCreator(index) {
    ...
    container.innerHTML = `
        <div class="creator-avatar-col">
            <img src="${creator.avatar}" class="creator-avatar-bg" data-original-src="${creator.avatar}">
            <div class="creator-avatar-overlay"></div>
            <img src="${creator.avatar}" class="creator-avatar-img" data-original-src="${creator.avatar}">
        </div>
